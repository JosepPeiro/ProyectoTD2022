...
datos_media$x = c(4.1, 3.8,5.3,5.4, 2.15, 4.6, seq(1,8,1))
datos_media$y = c(8.6, 9.35,6.7, 7,8.2, 8, seq(1,8,1))
# datos_media %>% summarise(min(media), max(media))

ggplot(datos_media, aes(x, y))+
 background_image(img)+
 geom_point(aes(size = media), color = "white")+scale_y_continuous(limits = c(0,13),breaks = seq(0,100,0.5))+scale_x_continuous(breaks = seq(0,100,0.5), limits = c(0,13))
```
