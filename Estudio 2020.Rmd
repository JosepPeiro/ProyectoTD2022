...
Calculamos la correlacion y covarianza para ver la similitud de la produccion de sonido dependiendo del momento del dia
...
```
Ponemos los datos tidy en orden de cuando fueran tomadas las muestras y agrupadas por calles
...
grid.arrange(gd1, gd2, ncol=2, top = "Comparación cantidad de sonido (violin y boxplot)")
```
...
Graficos del sonio¡do por calle dependiendo del momento del dia:
```{r}
