...
#ahora vamos a calcular los datos estadísticos edl año 2022, el mínimo,, el percentil, la mediana, la media, la desviacion típica, el percentil y el máximo, y tras ello, crearemos un vector con cada dato correspondiente.
```
