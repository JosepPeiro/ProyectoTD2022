...
names(calles)=c("SuecaEsqDenia", "Cadiz16", "Cadiz3", "Cuba3", "Sueca2", "Sueca61", "Sueca32", "CarlesCervera", "SalvadorAbril", "Vivons", "CarlesCervera34", "PuertoRico21", "DoctorSerrano21", "GeneralPrim")
```
...
for (e in calles){
  ...
  rownames(matriz_estadisticos)=c("a", "b", "c", "d", "f")
...
names(lista_estadisticos)=c("SuecaEsqDenia", "Cadiz16", "Cadiz3", "Cuba3", "Sueca2", "Sueca61", "Sueca32", "CarlesCervera", "SalvadorAbril", "Vivons", "CarlesCervera34", "PuertoRico21", "DoctorSerrano21", "GeneralPrim")
...
names(calles2) = c("SuecaEsqDenia", "Cadiz16", "Cadiz3", "Cuba3", "Sueca2", "Sueca61", "Sueca32", "CarlesCervera", "SalvadorAbril", "Vivons", "CarlesCervera34", "PuertoRico21", "DoctorSerrano21", "GeneralPrim")
...
datos = rbind(Cadiz16 %>% select(1, 6:11) %>% mutate(Calle="Cadiz16"),
               Cadiz3 %>% select(1, 6:11) %>% mutate(Calle="Cadiz3"),
               CarlesCervera %>% select(1, 6:11) %>% mutate(Calle="CarlesCervera"),
               CarlesCervera34 %>% select(1, 6:11) %>% mutate(Calle="CarlesCervera34"),
               Cuba3 %>% select(1, 6:11) %>% mutate(Calle="Cuba3"),
               DoctorSerrano21 %>% select(1, 6:11) %>% mutate(Calle="DoctorSerrano21"),
               GeneralPrim %>% select(1, 6:11) %>% mutate(Calle="GeneralPrim"),
               PuertoRico21 %>% select(1, 6:11) %>% mutate(Calle="PuertoRico21"),
               SalvadorAbril %>% select(1, 6:11) %>% mutate(Calle="SalvadorAbril"),
               Sueca2 %>% select(1, 6:11) %>% mutate(Calle="Sueca2"),
               Sueca32 %>% select(1, 6:11) %>% mutate(Calle="Sueca32"),
               Sueca61 %>% select(1, 6:11) %>% mutate(Calle="Sueca61"),
               SuecaEsqDenia %>% select(1, 6:11) %>% mutate(Calle="SuecaEsqDenia")
               )
```
...
datos2 = 
  Cadiz16 %>% dplyr::select(1, 6:11) %>% mutate(Calle="Cadiz16")%>% 
  full_join(Cadiz3 %>% select(1, 6:11) %>% mutate(Calle="Cadiz3")
            , by="dateObserved", suffix=c("_Cadiz16", "")) %>% 
  full_join(CarlesCervera %>% select(1, 6:11) %>% mutate(Calle="CarlesCervera")
            , by="dateObserved", suffix=c("_Cadiz3", "")) %>% 
  full_join(CarlesCervera34 %>% select(1, 6:11) %>% mutate(Calle="CarlesCervera34")
            , by="dateObserved", suffix=c("_CarlesCerCh", "")) %>%
  full_join(Cuba3 %>% select(1, 6:11) %>% mutate(Calle="Cuba3")
            , by="dateObserved", suffix=c("_CarlesCer34", "")) %>% 
  full_join(DoctorSerrano21 %>% select(1, 6:11) %>% mutate(Calle="DoctorSerrano21")
            , by="dateObserved", suffix=c("_Cuba3", "")) %>% 
  full_join(GeneralPrim %>% select(1, 6:11) %>% mutate(Calle="GeneralPrim")
            , by="dateObserved", suffix=c("_Serrano21", "")) %>% 
  full_join(PuertoRico21 %>% select(1, 6:11) %>% mutate(Calle="PuertoRico21")
            , by="dateObserved", suffix=c("_GenPrim", "")) %>% 
  full_join(SalvadorAbril %>% select(1, 6:11) %>% mutate(Calle="SalvadorAbril")
            , by="dateObserved", suffix=c("_PuertoRico21", "")) %>% 
  full_join(Sueca2 %>% select(1, 6:11) %>% mutate(Calle="Sueca2")
            , by="dateObserved", suffix=c("_SalvadorAbril", "")) %>% 
  full_join(Sueca32 %>% select(1, 6:11) %>% mutate(Calle="Sueca32")
            , by="dateObserved", suffix=c("_Sueca2", "")) %>% 
  full_join(Sueca61 %>% select(1, 6:11) %>% mutate(Calle="Sueca61")
            , by="dateObserved", suffix=c("_Sueca32", "")) %>% 
  full_join(SuecaEsqDenia %>% select(1, 6:11) %>% mutate(Calle="SuecaEsqDenia")
...
rownames(estadisticos_conjuntos)=c("a", "b", "c", "d", "f")
